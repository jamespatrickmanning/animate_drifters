...
area='NorthShore' # region to feed to "getgbox" function defining lat/lon box options include SNE, NorthShore, CCBAY, BoF
...
INPUT_FILENAME = 'drift_wnerr_2020_1.dat.txt' # you may need to download this to your machine (see nefsc.noaa.gov/drifter/drift_ecohab_2019_3.dat)
PATH_ANIM = ''#'c:\\Users\\Tanya\\eMOLT\\eMOLT\\src\\animations\\'
PATH_IMG = 'frame'#'c:\\Users\\Tanya\\eMOLT\\eMOLT\\src\\images\\%03d.png'
...
with open(INPUT_FILENAME, 'rb') as f:
    ...
    #dataReader.next()# commented out by JiM 7/21/2020
    try:
